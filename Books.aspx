<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Books.aspx.cs" Inherits="Alquds_book_store.Books" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="jumbotron">
      ...
      <div class="row">
        ...
        <tr >
        <td align="center"   style="color: #333333; "center"  font-weight: bold">
