<%@ Page Title="" Language="C#" MasterPageFile="~/Publishers/Publisher.Master" AutoEventWireup="true" CodeBehind="PublisherBooks.aspx.cs" Inherits="Alquds_book_store.Publishers.PublisherBooks" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <div class="jumbotron">
    
        <p class="lead">&nbsp;</p>
            <p class="lead" style="text-decoration: underline"><strong>Publisher Area. </strong> </p>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
              ...
              <p>
                  &nbsp;</p>
              <p>
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Books] WHERE ([PublisherID] = @PublisherID)">
                      <SelectParameters>
              ...
              <p>
                  <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Authors]">
                  </asp:SqlDataSource>
              </p>
              <p>
