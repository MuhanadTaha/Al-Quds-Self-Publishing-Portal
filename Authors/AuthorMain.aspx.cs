...
{
    public partial class AuthorMain : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Authors where UserID = '" + strCurrentUserId + "'", vcon);//Advised to use parameterized query
