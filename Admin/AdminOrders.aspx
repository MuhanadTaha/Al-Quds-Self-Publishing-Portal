<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminOrders.aspx.cs" Inherits="Alquds_book_store.Admin.AdminOrders" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       <div class="jumbotron">
    
        <p class="lead">&nbsp;</p>
            <p class="lead" style="text-decoration: underline"><strong>Admin Main Area. </strong> </p>
            <p class="lead" style="text-decoration: underline"><strong>all&nbsp; books Orders</strong></p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
              <p>
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="OrderID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="580px">
              ...
              <p>
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Orders]">
                  </asp:SqlDataSource>
              </p>
              <p>
